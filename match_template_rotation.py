...
def match(img, temp, threshold):
    ...
    ref = np.array(temp, dtype=np.uint8)
    rotations = [
...
match(cv2.imread("./images/flower-field.jpeg"), cv2.imread("./images/flower-field-template - rotated.jpg", cv2.IMREAD_GRAYSCALE), 0.7)
